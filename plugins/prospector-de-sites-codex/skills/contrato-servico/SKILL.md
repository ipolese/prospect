...
description: Gerar contratos de prestação de serviço para clientes fechados, incluindo redesign de site, publicação e manutenção opcional. Usar em contrato, formalização, cliente fechado ou envio de minuta.
---
...
- Template: `references/contrato-template.html` + `references/contrato-print.js` — arquivo com CSS A4 de impressão. Substituir todos os `{{PLACEHOLDERS}}`; conferir que nenhum sobrou (busca por `{{`).
